...
public class LastRotationMotor : MonoBehaviour
{

    Motor2 motor;
    Rigidbody myR;
    LastRotationPid myRotationPid;

    [SerializeField] Transform leftMotor, rightMotor;
    ...
    private void Start()
    {
        motor = GetComponent<Motor2>();
        myRotationPid = GetComponent<LastRotationPid>();
